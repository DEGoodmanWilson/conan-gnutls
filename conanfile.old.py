...
class GnutlsConan(ConanFile):
    ...
    requires = 'libiconv/1.15@bincrafters/stable', 'nettle/3.3@DEGoodmanWilson/testing', 'gmp/6.1.1@DEGoodmanWilson/stable', 'zlib/1.2.8@conan/stable'
    ...
    def source(self):
        ...
        # download("http://ftp.heanet.ie/mirrors/ftp.gnupg.org/gcrypt/gnutls/v3.6/%s" % zip_name, zip_name)
